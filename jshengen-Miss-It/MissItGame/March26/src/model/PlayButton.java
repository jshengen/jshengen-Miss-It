...
public class PlayButton extends Button{
	...
	private final String GIT_FONT_PATH = "MissItGame/March26/src/model/resources/CaviarDreams.ttf";
	private final String JAR_FONT_PATH = "/model/resources/CaviarDreams.ttf";
	...
	private void setButtonFont() {
		...
		try {
			...
			try {
				setFont(Font.loadFont(new FileInputStream(GIT_FONT_PATH), FontSize));
			}
				...
				try {
					...
					InputStream is = getClass().getResourceAsStream(JAR_FONT_PATH);
